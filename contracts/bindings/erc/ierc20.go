...
func (_Bindings *BindingsCaller) Allowance(opts *bind.CallOpts, _owner common.Address, _spender common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "allowance", _owner, _spender)
...
//
// Solidity: function allowance(address _owner, address _spender) returns(uint256)
func (_Bindings *BindingsSession) Allowance(_owner common.Address, _spender common.Address) (*big.Int, error) {
	return _Bindings.Contract.Allowance(&_Bindings.CallOpts, _owner, _spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address _owner, address _spender) returns(uint256)
func (_Bindings *BindingsCallerSession) Allowance(_owner common.Address, _spender common.Address) (*big.Int, error) {
	return _Bindings.Contract.Allowance(&_Bindings.CallOpts, _owner, _spender)
}
...
func (_Bindings *BindingsCaller) BalanceOf(opts *bind.CallOpts, _owner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "balanceOf", _owner)
...
//
// Solidity: function balanceOf(address _owner) returns(uint256 balance)
func (_Bindings *BindingsSession) BalanceOf(_owner common.Address) (*big.Int, error) {
	return _Bindings.Contract.BalanceOf(&_Bindings.CallOpts, _owner)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address _owner) returns(uint256 balance)
func (_Bindings *BindingsCallerSession) BalanceOf(_owner common.Address) (*big.Int, error) {
	return _Bindings.Contract.BalanceOf(&_Bindings.CallOpts, _owner)
}
...
func (_Bindings *BindingsTransactor) Approve(opts *bind.TransactOpts, _spender common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "approve", _spender, _value)
}
...
func (_Bindings *BindingsSession) Approve(_spender common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.Approve(&_Bindings.TransactOpts, _spender, _value)
}
...
func (_Bindings *BindingsTransactor) Transfer(opts *bind.TransactOpts, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "transfer", _to, _value)
}
...
func (_Bindings *BindingsSession) Transfer(_to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.Transfer(&_Bindings.TransactOpts, _to, _value)
}
...
func (_Bindings *BindingsTransactor) TransferFrom(opts *bind.TransactOpts, _from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "transferFrom", _from, _to, _value)
}
...
func (_Bindings *BindingsSession) TransferFrom(_from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.TransferFrom(&_Bindings.TransactOpts, _from, _to, _value)
}
